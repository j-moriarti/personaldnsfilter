	...
	public static void main(String[] args) throws Exception {
		...
		class StandaloneLogger  implements LoggerInterface {
			...
			public void logLine(String txt) {
				...
				if (txt.endsWith("     ")) {
					System.out.println(ansi().fgBrightYellow().a(txt).reset().toString());
				}
				else if (txt.endsWith("    ")) {
					System.out.println(ansi().fgBrightRed().a(txt).reset().toString());
				}
				else if (txt.endsWith("   ")) {
					System.out.println(ansi().fgBrightGreen().a(txt).reset().toString());
				}
				else if (txt.endsWith("  ")) {
					System.out.println(ansi().fgBrightMagenta().a(txt).reset().toString());
				}
				else if (txt.endsWith(" ")) {
					System.out.println(ansi().fgBrightCyan().a(txt).reset().toString());
				}
				else {
